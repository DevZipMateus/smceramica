...
const AboutUs = () => {
  return <section id="about" className="section bg-neutral-50">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="relative">
              ...
              <img src="/lovable-uploads/925166a4-871d-418f-b99b-cd253b927df7.png" alt="Abrasivos cerâmicos e porcelanas alumina para tamboreamento e vibroacabamento - diferentes formatos e tamanhos" className="relative z-10 rounded-lg shadow-lg w-full h-[400px] object-none" />
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-6 animate-fade-in" style={{
            animationDelay: '0.1s'
          }}>
              Mais de 30 Anos Fabricando Abrasivos Cerâmicos de Qualidade
            </h2>
            <p className="text-neutral-600 mb-6 animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
            ...
            <p className="text-neutral-600 mb-8 animate-fade-in" style={{
            animationDelay: '0.3s'
          }}>
            ...
            <a href="https://wa.me/5511968209575" target="_blank" rel="noopener noreferrer" className="bg-neutral-900 hover:bg-neutral-800 text-white px-6 py-3 rounded-md transition-all flex items-center justify-center gap-2 font-medium inline-flex animate-fade-in" style={{
            animationDelay: '0.7s'
          }}>
